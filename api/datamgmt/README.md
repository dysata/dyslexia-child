Здесь приведена инструкция по развертыванию сервиса datamgmt в самостоятельном режиме на localhost. О развертывании в составе программного комплекса см. README.md в корне репозитория. 
