Здесь приведена инструкция по развертыванию сервиса datamgmt в самостоятельном режиме на localhost. О развертывании в составе прогарммного комплекса см. README.md в корне репозитория. 

# Требования
- Браузер: Firefox (т.к. используется ogg аудио)
...
Остановив контейнеры (docker-compose down) можно создать базу данных ```_users``` в CouchDB, чтобы подавить сообщения об ее отсутствии в логах (вместо admin, password используйте ваши данные, установленные в соответствии с п.1.):
