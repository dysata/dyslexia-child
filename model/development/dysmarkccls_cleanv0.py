#!/usr/bin/env python3
"""
Dysmark Transcriber and Aligner (v0 — без markI, как в dysmarkcclsjson.py)
================================
...
Library Usage:
from dysmarkccls_cleanv0 import get_markers
triples = get_markers(reference_text="hello world", audio_path="audio.wav")

CLI Usage:
# Simple mode (2 positional args)
python3 dysmarkccls_cleanv0.py text.txt audio.wav
# Directory mode (flags)
python3 dysmarkccls_cleanv0.py -a <audio_dir> -t <reference_text_file> -o <output_base>
"""
...
# Error Marking
# =============================================================================
def _apply_error_marks(segments):
...
def _process_audio_text_pair(reference_text, audio_path, processor, model):
    ...
    marked_segments = _apply_error_marks(segments2)
